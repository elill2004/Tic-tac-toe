...
v_rect2 = pygame.Rect(690, 750, 600, 100)
...
def display_winner(player):
	...
	font = pygame.font.Font(None,100) # 100 is for font size
	location =(CELL_SIZE,750)
	screen.blit(font.render("WINNER!!", True,RED),location)
	
	# restart game option
	pygame.draw.rect(screen, BG_COLOR, v_rect)
	pygame.draw.rect(screen, BG_COLOR, v_rect2)
	pygame.draw.rect(screen, BLACK, pygame.Rect(100, 100, 700, 150))
	screen.blit(font.render("RESTART GAME",True,WHITE),(150,150))
	screen.blit(font.render("QUIT",True,WHITE),(690,750))
